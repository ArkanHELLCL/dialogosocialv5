...
<%	
	...
	TOR_Nombre       = LimpiarUrl(Request("TOR_Nombre"))
	TOR_Estado       = 1
 
 
	datos =    TOR_Id & ",'" & TOR_Nombre & "'," & TOR_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spTipoOrganizacion_Modificar " & datos 
