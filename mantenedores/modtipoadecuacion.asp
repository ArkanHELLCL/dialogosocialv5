...
<%	
	...
	TAD_Descripcion       	= LimpiarUrl(Request("TAD_Descripcion"))	
	TAD_EStado       		= Request("TAD_EStado")
  
	datos =   TAD_Id & ",'" & TAD_Descripcion & "'," & TAD_EStado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spTiposAdecuaciones_Modificar] " & datos 
