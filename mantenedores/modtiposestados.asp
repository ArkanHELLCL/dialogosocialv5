...
<%	
	...
	TES_Descripcion       	= LimpiarUrl(Request("TES_Descripcion"))
  
	datos =   EST_Estado & ",'" & TES_Descripcion & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spTipoEstado_Modificar] " & datos 
