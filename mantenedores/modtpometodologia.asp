...
<%	
	...
	MET_Descripcion       	= LimpiarUrl(Request("MET_Descripcion"))	
	MET_Estado       		= Request("MET_Estado")
  
	datos =   MET_Id & ",'" & MET_Descripcion & "'," & MET_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spMetodologia_Modificar] " & datos 
