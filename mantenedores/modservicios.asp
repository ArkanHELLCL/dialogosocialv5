...
<%	
	...
	SER_Nombre	= LimpiarUrl(Request("SER_Nombre"))
	SER_Estado  = 1

  
	datos = SER_Id & "," & GOB_Id & ",'" & SER_Nombre & "'," & SER_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spServicio_Modificar " & datos 
