...
<%	
	...
	TDG_Nombre  = LimpiarUrl(Request("TDG_Nombre"))	
	TDG_Estado  = Request("TDG_Estado")
  
	datos =   TDG_Id & ",'" & TDG_Nombre & "',"	& TDG_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spTipoDocumentoGobierno_Modificar] " & datos 
