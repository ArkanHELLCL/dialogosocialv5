...
<%	
	...
	BLF_Estado	= Request("BLF_Estado")
  
	datos =   BLF_Id & "," & BAS_Id & "," & LFO_Id & "," & BLF_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spBasesLineaFormativa_Modificar] " & datos 
