...
<%	
	...
	NAC_Nombre       = LimpiarUrl(Request("NAC_Nombre"))
	NAC_Estado       = 1
 
 
	datos =    NAC_Id & ",'" & NAC_Nombre & "'," & NAC_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spNacionalidad_Modificar " & datos 
