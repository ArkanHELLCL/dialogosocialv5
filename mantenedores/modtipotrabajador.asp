...
<%	
	...
	TTR_Nombre		= LimpiarUrl(Request("TTR_Nombre"))
	TTR_Estado 		= 1	
 
	datos = TTR_Id & ",'" & TTR_Nombre & "'," & TTR_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spTipoTrabajador_Modificar " & datos 
