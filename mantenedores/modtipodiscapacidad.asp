...
<%	
	...
	TDI_Nombre		= LimpiarUrl(Request("TDI_Nombre"))
	TDI_Estado 		= 1	
 
	datos = TDI_Id & ",'" & TDI_Nombre & "'," & TDI_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spTipoDiscapacidad_Modificar " & datos 
