...
<%	
	...
	datos = "'" & EMP_Nombre & "','" & EMP_Direccion & "','" & EMP_telefono & "','" & EMP_Rol & "'," & RUB_Id & ",'" & EMP_NumTrabajadores & "','" & EMP_NumMujeres & "'," & EMP_NumHombres & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spEmpresa_Agregar " & datos 
