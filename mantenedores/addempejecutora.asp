...
<%	
	...
	datos = "'" & EME_Rol & "','" & EME_Nombre & "','" & EME_Direccion & "'," & COM_Id & ",'" & EME_Telefono & "','" & EME_NombreContacto & "','" & EME_CargoContacto & "','" & EME_Mail & "','" & EME_PaginaWeb & "'," & TEJ_Id & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spEmpresaEjecutora_Agregar] " & datos 
