...
<%	
	...
	datos =  LFO_Id & ",'" & LIN_Nombre & "'," & LIN_AgregaTematica & "," & LIN_Hombres & "," & LIN_Mujeres & "," & LIN_DiasCierreInformeParcial & "," & LIN_DiasCierreInformeFinal & "," & LIN_DiasCierreInformeParcial50Ejecucion & "," & LIN_DiasCierreInformeFinal100Ejecucion & "," & LIN_PorcentajeMaxAsistenciaDesercion & "," & LIN_PorcentajeMaxAsistenciaReprobacion & "," & LIN_DiasIngresoAsistencia & "," & LIN_PorcentajeMaxAsistenciaInscrito & "," & LIN_Mixta & "," & LIN_AgregaSindicato & "," & LIN_AgregaSindicatoVerificador & "," & LIN_AgregaEmpresa & "," & LIN_AgregaEmpresaVerificador & "," & LIN_AgregaCivil & "," & LIN_AgregaCivilVerificador & "," & LIN_AgregaGobierno & "," & LIN_AgregaGobiernoVerificador & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spLinea_Agregar " & datos 
