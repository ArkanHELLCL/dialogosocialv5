				...
				<div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center" style="height:3rem;">
					<div><%
						if session("ds5_usrperfil")=1 then%>
							<button class="btn btn-success btn-rounded btn-sm waves-effect" title="Crear un nueva liena formativa" type="button" data-url="" data-toggle="tooltip" data-id="10" id="btn_adddepartamentosModal" name="btn_adddepartamentosModal">Agregar<i class="fas fa-plus ml-1"></i></button><%
						end if%>
					</div>
