...
<%	
	...
	GRA_Descripcion       	= LimpiarUrl(Request("GRA_Descripcion"))	
	GRA_Estado       		= Request("GRA_Estado")
  
	datos =   GRA_Id & ",'" & GRA_Descripcion & "'," & GRA_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"	
	...
	sql="exec [spGravedadIncumplimiento_Modificar] " & datos 
