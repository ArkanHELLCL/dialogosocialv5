...
<%	
	...
	sql="exec spBeneficiario_Modificar " & datos 	
	...
	if cnn.Errors.Count > 0 then 
	    ...
	    response.End()
	End If		
	response.write("200\\Beneficiario modificado exitosamente ")	
%>