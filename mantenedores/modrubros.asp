...
<%	
	...
	RUB_Nombre       = LimpiarUrl(Request("RUB_Nombre"))
	RUB_Estado       = Request("RUB_Estado")
 
 
	datos =   RUB_Id & ",'" & RUB_Nombre & "'," & RUB_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spRubro_Modificar " & datos 
