				...
				<div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center" style="height:3rem;">
					<div><%
						if session("ds5_usrperfil")=1 then%>
							<button class="btn btn-success btn-rounded btn-sm waves-effect" title="Crear un nueva liena formativa" type="button" data-url="" data-toggle="tooltip" data-id="10" id="btn_addusuariosModal" name="btn_addusuariosModal">Agregar<i class="fas fa-plus ml-1"></i></button><%
						end if%>
					</div>
						...
						<table id="tbl-usuarios" class="table-striped table-bordered dataTable table-sm" cellspacing="0" width="100%" data-id="usuarios" >
							<thead>
								<tr> 
									...
									<th style="display:none">Región</th>
									<th style="display:none">Departamento</th>
									<th style="display:none">LDAP</th>
								</tr> 
							</thead>
							<tbody>
							</tbody>
			...
			usuariosTable = $('#tbl-usuarios').DataTable({
				...
				"fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {					
					$(nRow).click(function(e){						
						...
						var USR_Identificador = $(this).find("td")[1].innerText;
						var data={USR_Id:USR_Id,USR_Identificador:USR_Identificador,mode:'mod'}
