...
<%	
	...
	MON_Descripcion       	= LimpiarUrl(Request("MON_Descripcion"))	
	MON_Estado       		= Request("MON_Estado")
  
	datos =   MON_Id & ",'" & MON_Descripcion &  "'," & MON_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spMoneda_Modificar] " & datos 
