...
<%	
	...
	TEM_Nombre   = LimpiarUrl(Request("TEM_Nombre"))
	PER_Id       = Request("PER_Id")
	TEM_Horas	 = Request("TEM_Horas")
	TEM_Minutos	 = "NULL"
	
	if(isNULL(TEM_Horas) or TEM_Horas="") then
		TEM_Horas="NULL"
	end if
  
	datos =   TEM_Id & ",'" & TEM_Nombre & "'," & TEM_Horas & "," & TEM_Minutos & "," & PER_Id & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec spTematica_Modificar " & datos 
