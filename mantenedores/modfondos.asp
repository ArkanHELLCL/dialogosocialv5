...
<%	
	...
	FON_Nombre	= LimpiarUrl(Request("FON_Nombre"))	
	FON_Estado  = Request("FON_Estado")
  
	datos =   FON_Id & ",'" & FON_Nombre & "',"	& FON_Estado & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	sql="exec [spFondos_Modificar] " & datos 
