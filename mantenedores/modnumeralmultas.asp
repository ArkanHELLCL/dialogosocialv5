...
<%	
	...
	NUM_NumeralMultas 		= LimpiarUrl(Request("NUM_NumeralMultas"))	
  
	datos = NUM_Id & "," & BAS_Id & ",'" & NUM_NumeralMultas & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"		
	...
	sql="exec [spNumeralMultas_Modificar] " & datos 
