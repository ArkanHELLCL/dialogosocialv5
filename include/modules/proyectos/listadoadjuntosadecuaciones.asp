...
<%		
	...
	if not rs.eof then
		...
		path="D:\DocumentosSistema\dialogosocial\" & carpeta & "\adecuaciones\ade-" & yADE_Id & "\"
	else
	...
	response.write("200\\")%>	
	<table id="tbl-archivosplnmar" class="table table-striped table-bordered table-sm" data-id="archivosplnmar" data-page="false" data-selected="false" data-keys="0" style="margin-top:20px;" width="100%"> 
	<thead> 
		<tr> 
			<th>Corr</th> 
			<th>Nombre</th>
