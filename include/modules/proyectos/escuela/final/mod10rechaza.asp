...
<%	
	...
	TIP_Id				= 8	'Observaciones al informe FINAL
	...
	sql="exec spProyectoInformeFinal_Abrir " & PRY_Id & ",'" & PRY_Identificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	{"state": 200, "message": "Informe Final correctamente rechazado","data": null}<%
