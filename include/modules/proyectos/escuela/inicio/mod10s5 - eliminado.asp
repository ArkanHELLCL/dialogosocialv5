...
<%
	...
	PRY_Metodologia 	    = LimpiarUrl(request("PRY_Metodologia"))
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "','" & PRY_Metodologia & "'," & PRY_Step & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"

	sql="exec [spProyecto_MetodologiaModificar] " & datos 	
