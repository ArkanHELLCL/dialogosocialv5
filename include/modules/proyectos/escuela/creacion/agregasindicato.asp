...
<%	
	...
	PAT_Compromiso=request("PAT_Compromiso")
	PAT_VerificadorCumplimiento=""

	sql = "exec spPatrocinio_Agregar " & PRY_Id & "," & SIN_Id & ",'" & PAT_Compromiso & "','" & PAT_VerificadorCumplimiento & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"	
