				...
				$.ajax({
					...
					success: function(data) {					
						...
						if(param[0]=="200"){
							...
							wrk_informes('/prt-informecreacionescuela','informecreacion.pdf',<%=PRY_Id%>,'<%=PRY_Identificador%>','/mnu-10',<%=session("ds5_usrid")%>,'<%=session("ds5_usrtoken")%>');
