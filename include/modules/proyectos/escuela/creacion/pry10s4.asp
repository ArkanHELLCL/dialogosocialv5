			...
			<div class="header">				
				<div class="content-nav"><%
					...
					if(LIN_AgregaCivil) then%>					
						<a id="org3-tab" href="#civtab3" class="tab"><i class="fas fa-building"></i> Organizaciones Civiles 
							<span class="badge right blue badgeciv">0</span>
						</a><%
					end if
					if(LIN_AgregaGobierno) then%>					
						<a id="org4-tab" href="#gobtab3" class="tab"><i class="fas fa-university"></i> Organizaciones de Gobierno 
					...
					if(not LIN_AgregaSindicato and not LIN_AgregaEmpresa and not LIN_AgregaCivil and not LIN_AgregaGobierno) then%>
						<a id="org5-tab" href="#nottab3" class="tab"><i class="fas fa-times"></i> Sin Redes de Apoyo (Ver Mantenedor de Lineas) 							
						</a><%
					end if%>
			...
			<div class="tab-content"><%
				if(LIN_AgregaSindicato) then%>
					<div id="sintab1">	<%'Organizaciones Sindicales
						if(mode="mod") then%>
							<form role="form" action="/agregar-sindicato" method="POST" name="frm10s4_1" id="frm10s4_1" class="needs-validation">
								<div class="row">                                                                         
									...
									<div class="col-sm-1 col-md-1 col-lg-1" style="padding-top: 23px;text-align:left;">
										<button type="button" class="btn btn-success btn-md waves-effect waves-dark" id="btn_frm10s4_1" name="btn_frm10s4_1"><i class="fas fa-plus"></i></button>	
									</div>						
								</div>	
				...
				if(LIN_AgregaEmpresa) then%>
					<div id="emptab2">	<%'Organizaciones Empresariales
						if(mode="mod") then%>
							<form role="form" action="/agregar-empresa" method="POST" name="frm10s4_2" id="frm10s4_2" class="needs-validation">				
								<div class="row">                                                                         
									<div class="col-sm-5 col-md-5 col-lg-5">
										<div class="md-form input-with-post-icon">
											<div class="error-message">
									...
									<div class="col-sm-1 col-md-1 col-lg-1" style="padding-top: 23px;text-align:left;">
										<button type="button" class="btn btn-success btn-md waves-effect waves-dark" id="btn_frm10s4_2" name="btn_frm10s4_2"><i class="fas fa-plus"></i></button>	
									</div>						
								</div>	
								<input type="hidden" id="PRY_Id" value="<%=PRY_Id%>" name="PRY_Id">
							</form><%
				...
				if(LIN_AgregaCivil) then%>
					<div id="civtab3">	<%'Organizaciones Civiles
						if(mode="mod") then%>
							<form role="form" action="/agregar-civil" method="POST" name="frm10s4_3" id="frm10s4_3" class="needs-validation">				
								<div class="row">                                                                         
									<div class="col-sm-5 col-md-5 col-lg-5">
										<div class="md-form input-with-post-icon">
											<div class="error-message">
									...
									<div class="col-sm-1 col-md-1 col-lg-1" style="padding-top: 23px;text-align:left;">
										<button type="button" class="btn btn-success btn-md waves-effect waves-dark" id="btn_frm10s4_3" name="btn_frm10s4_3"><i class="fas fa-plus"></i></button>	
									</div>						
								</div>	
								<input type="hidden" id="PRY_Id" value="<%=PRY_Id%>" name="PRY_Id">
							</form><%
				...
				if(LIN_AgregaGobierno) then%>
					<div id="gobtab3">	<%'Organizaciones de Gobierno
						if(mode="mod") then%>
							<form role="form" action="/agregar-gobierno" method="POST" name="frm10s4_4" id="frm10s4_4" class="needs-validation">				
								<div class="row">                                                                         
									<div class="col-sm-5 col-md-5 col-lg-5">
										<div class="md-form input-with-post-icon">
											<div class="error-message">
									...
									<div class="col-sm-1 col-md-1 col-lg-1" style="padding-top: 23px;text-align:left;">
										<button type="button" class="btn btn-success btn-md waves-effect waves-dark" id="btn_frm10s4_4" name="btn_frm10s4_4"><i class="fas fa-plus"></i></button>	
									</div>						
								</div>	
								<input type="hidden" id="PRY_Id" value="<%=PRY_Id%>" name="PRY_Id">
							</form><%
...
<script>	
	$(document).ready(function() {			
		...
		<%if(LIN_AgregaCivil) then%>
			...
			$("#btn_frm10s4_3").click(function(){
				formValidate("#frm10s4_3")
				if($("#frm10s4_3").valid()){
					$.ajax({
						type: 'POST',			
						url: $("#frm10s4_3").attr("action"),
						data: $("#frm10s4_3").serialize(),
						success: function(data) {					
							param=data.split(bb);						
		...
		<%if(LIN_AgregaEmpresa) then%>
			...
			$("#btn_frm10s4_2").click(function(){
				formValidate("#frm10s4_2")
				if($("#frm10s4_2").valid()){
					$.ajax({
						type: 'POST',			
						url: $("#frm10s4_2").attr("action"),
						data: $("#frm10s4_2").serialize(),
						success: function(data) {					
							param=data.split(bb);						
		...
		<%if(LIN_AgregaGobierno) then%>
			...
			$("#btn_frm10s4_4").click(function(){
				formValidate("#frm10s4_4")
				if($("#frm10s4_4").valid()){
					$.ajax({
						type: 'POST',			
						url: $("#frm10s4_4").attr("action"),
						data: $("#frm10s4_4").serialize(),
						success: function(data) {					
							param=data.split(bb);						
