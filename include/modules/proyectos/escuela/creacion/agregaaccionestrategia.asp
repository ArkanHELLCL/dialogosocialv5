...
<%	
	...
	ESC_Accion=request("ESC_Accion")    
	ESC_DescripcionAccion=request("ESC_DescripcionAccion")
    ESC_Verificador=""
    ESC_EstrategiaImplementar=""
		
	sql = "exec spEstrategiaConvocatoria_Agregar " & PRY_Id & ",'" & ESC_EstrategiaImplementar & "','" & ESC_Accion & "','" & ESC_DescripcionAccion & "','" & ESC_Verificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"    
