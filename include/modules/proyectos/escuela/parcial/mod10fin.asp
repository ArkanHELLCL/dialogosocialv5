...
<%	
	...
	TIP_Id				= 28	'Cierre Informe PARCIAL
	MEN_Archivo			= ""	'Sin adjuntos
	MEN_Texto			= "Informe DESARROLLO ha sido CERRADO (ESCUELA)"
	MEN_Archivo			= ""
	...
	sql="exec spProyectoInformeParcial_Cerrar " & PRY_Id & ",'" & PRY_Identificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	{"state": 200, "message": "Informe Incio correctamente cerrado","data": null}<%
