...
<%	
	...
	sqx="exec spRepProyectoSindicato_Eliminar " & RPS_Id & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	if cnn.Errors.Count > 0 then
		...
		response.end()
	End If%>	
	{"state": 200, "message": "Eliminación de representante de sindicato correcta","data": null}