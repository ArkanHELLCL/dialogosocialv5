		...
		<div class="col-sm-12 col-md-4 col-lg-4">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeFinalFecha" class="<%=lblClass%>">Fecha Cierre Informe Nro 2 (<%=LIN_DiasCierreInformeFinal%>)</label>									
				</div>
			</div>
		</div>
	</div>	
		...
		<div class="col-sm-12 col-md-4 col-lg-4">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeFinalFechaOriginal" class="<%=lblClass%>">Fecha Cierre Informe Nro 2</label>									
				</div>
			</div>
		</div>
	</div>
