...
<%
	...
	if(mode="mod") then%>
		...
		<form role="form" action="/agregar-tematica" method="POST" name="frm12s4_1" id="frm12s4_1" class="needs-validation">			
			<div class="row"> 
	...
	<div class="row" style="padding-top:20px">				
		<div class="col-12">			
			<span class="text-muted" style="float:left;padding-bottom:20px">Módulos adicionales incorporados</span>
