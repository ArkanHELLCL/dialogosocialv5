...
{  	  
      ...
      $PRY_FundamentacionCriterioFocalizacion = $row['PRY_FundamentacionCriterioFocalizacion'];
      $PRY_EnfoquePedagogico = $row['PRY_EnfoquePedagogico'];
      //Criterios de Focalización
...
<table  border="0">
  <tr>
    ...
    <th scope="col" width="10%">Experiencia</th>
    <th scope="col" width="20%">Metodología</th>
  </tr>
  <tr>
    <td width="35%">'.$USR_NombreEjecutor." ".$USR_ApellidoEjecutor.'</td>
    <td width="35%">'.$USR_NombreRevisor." ".$USR_ApellidoRevisor.'</td>
    <td width="10%">'.$PRY_NumAnoExperiencia.'</td>
...
$html = $htmlstyle.'<h4>Fechas de Cierre</h4>
                ...
                <table  border="0">
                <tr>
                    <th scope="col" width="50%">Fecha Cierre Informe Incial</th>                    
                    <th scope="col" width="50%">Fecha Cierre Informe Final</th>
                </tr>
                <tr>
                    <td width="50%">'.$PRY_InformeInicioFecha.'</td>                    
                    <td width="50%">'.$PRY_InformeFinalFecha.'</td>
                </tr>
                </table>                
                ...
                <tr>
                    <td width="50%">'.$PRY_InformeInicioFechaOriginal.'</td>                    
                    <td width="50%">'.$PRY_InformeFinalFechaOriginal.'</td>
                </tr>
                </table>';
