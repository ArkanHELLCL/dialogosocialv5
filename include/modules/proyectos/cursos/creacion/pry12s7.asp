		...
		<div class="container-nav" style="margin-right: 15px;margin-left: 15px;">
			<div class="header">				
				<div class="content-nav">					
					<a id="plc2-tab" href="#plncomtab1" class="tab"><i class="fas fa-tasks"></i> Plan Comuncacional 
						<span class="badge right blue plancom">0</span>
					</a>
					<a id="pln2-tab" href="#plncontab2" class="tab"><i class="fas fa-tasks"></i> Plan de Contingencia 
			...
			<div class="tab-content">
				<div id="plncomtab1"><%
					if(mode="mod") then%>
						<form role="form" action="/agregar-plan-comunicacional" method="POST" name="frm12s7_1" id="frm12s7_1" class="needs-validation">			
							...
							<div class="row">
								...
								<div class="col-1">
									<button type="button" class="btn btn-success btn-md waves-effect waves-dark" id="btn_frm12s7_1" name="btn_frm12s7_1"><i class="fas fa-plus"></i></button>
								</div>
							</div>
				...
				<div id="plncontab2"><%
					if(mode="mod") then%>
						<form role="form" action="/agregar-plan-de-contingencia" method="POST" name="frm12s7_2" id="frm12s7_2" class="needs-validation">			
							<div class="row" style="position:relative;padding-top:20px">								
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
									<div class="md-form">
										<div class="error-message">					
							...
							<div class="row">
								...
								<div class="col-1">
									<button type="button" class="btn btn-success btn-md waves-effect waves-dark" id="btn_frm12s7_2" name="btn_frm12s7_2"><i class="fas fa-plus"></i></button>
								</div>
							</div>
							<input type="hidden" id="PRY_Id" value="<%=PRY_Id%>" name="PRY_Id">
						</form><%
	...
	<div class="row">		
		<div class="footer"><%
			if mode="mod" or mode="add" then%>
				<form role="form" action="<%=action%>" method="POST" name="frm12s7" id="frm12s7" class="needs-validation">
					<button type="button" class="btn <%=btnColor%> btn-md waves-effect waves-dark" id="btn_frm12s7" name="btn_frm12s7"><%=txtBoton%></button>
...
<script>
	$(document).ready(function() {	
		...
		$("#btn_frm12s7").click(function(){
			formValidate("#frm12s7")
			if($("#frm12s7").valid()){
				var min = 0;
				if(plnconTable.data().count()<min){
					...
					$.ajax({
						type: 'POST',			
						url: $("#frm12s7").attr("action"),
						data: $("#frm12s7").serialize(),
		...
		$("#btn_frm12s7_1").click(function(){
			formValidate("#frm12s7_1")
			if($("#frm12s7_1").valid()){
				$.ajax({
					type: 'POST',			
					url: $("#frm12s7_1").attr("action"),
					data: $("#frm12s7_1").serialize(),
					success: function(data) {					
						param=data.split(bb);						
		...
		$("#btn_frm12s7_2").click(function(){
			formValidate("#frm12s7_2")
			if($("#frm12s7_2").valid()){
				$.ajax({
					type: 'POST',			
					url: $("#frm12s7_2").attr("action"),
					data: $("#frm12s7_2").serialize(),
					success: function(data) {					
						param=data.split(bb);						
