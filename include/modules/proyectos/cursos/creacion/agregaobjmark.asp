...
<%	
	...
	OPM_ObjetivoEspecifico	= LimpiarUrl(request("OPM_ObjetivoEspecifico"))
		
	sql = "exec spObjetivoEspPlanMarketing_Agregar '" & OPM_ObjetivoEspecifico & "'," & PRY_Id & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"	
