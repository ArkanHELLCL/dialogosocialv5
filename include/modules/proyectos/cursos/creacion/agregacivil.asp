...
<%	
	...
	sql = "exec spPatrocinioCiviles_Agregar " & PRY_Id & "," & CIV_Id & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"	
	...
	dataCiviles = "["
	do While Not rs.EOF
		dataCiviles = dataCiviles & "{""CIV_Id"":""" & rs("CIV_Id") & """,""CIV_Nombre"":""" & rs("CIV_Nombre") & """,""RUB_Nombre"":""" & rs("RUB_Nombre") & """,""Del"":""<i class='fas fa-trash-alt text-danger' data-civ='" & rs("CIV_Id") & "' data-pry='" & PRY_Id & "'></i>"""
