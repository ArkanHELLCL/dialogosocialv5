...
<%
	...
	if(mode="mod") then%>
		...
		<form role="form" action="/agregar-estrategia-convocatoria" method="POST" name="frm12s6_1" id="frm12s6_1" class="needs-validation">			
			<div class="row"> 
				...
				<div class="col align-self-end">
					<button type="button" class="btn btn-success btn-md waves-effect waves-dark" id="btn_frm12s6_1" name="btn_frm12s6_1" style="float: right;"><i class="fas fa-plus"></i></button>
				</div>
			</div>
...
<script>
	$(document).ready(function() {	
		...
		$("#btn_frm12s6_1").click(function(){
			formValidate("#frm12s6_1")
			if($("#frm12s6_1").valid()){
				$.ajax({
					type: 'POST',			
					url: $("#frm12s6_1").attr("action"),
					data: $("#frm12s6_1").serialize(),
