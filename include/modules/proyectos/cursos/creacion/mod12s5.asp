...
<%
	...
	PRY_FundamentacionCriterioFocalizacion = LimpiarUrl(request("PRY_FundamentacionCriterioFocalizacion"))
	PRY_EnfoquePedagogico = LimpiarUrl(request("PRY_EnfoquePedagogico"))
	...
	sql="exec spProyecto_CriteriosFocalizacionModificar " & PRY_Id & ",'" & PRY_Identificador & "','" & PRY_FundamentacionCriterioFocalizacion & "','" & PRY_EnfoquePedagogico & "'," & PRY_Step & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
