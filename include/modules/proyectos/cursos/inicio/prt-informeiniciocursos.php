...
{  	  
      ...
      //Responsables del proyecto
      //Responsables de rendicion Bárbara
...
$pdf->AddPage('L','A4');
$html = $htmlstyle.'<h4>Estadística de Alumnos</h4>
...
$html = $htmlstyle.'<h4>Actividades</h4>                
                <h5>Clase de Inicio y/o Inauguración</h5>
                <table border="0">
                  <tr>
                ...
                <h5>Ceremonia de certificación y entrega de diplomas</h5>
                <table border="0">
                  <tr>
