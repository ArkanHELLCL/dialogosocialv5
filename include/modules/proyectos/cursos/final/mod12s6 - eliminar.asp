...
<%	
	...
	PRY_ObsEjecucion	= LimpiarUrl(request("PRY_ObsEjecucion"))
	PRY_ObsGeneral		= LimpiarUrl(request("PRY_ObsGeneral"))
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "'," & PRY_Step & ",'" & PRY_ObsEjecucion & "','" & PRY_ObsGeneral & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"

	sql="exec [spProyectoInformeFinalObservaciones_Modificar] " & datos 	
