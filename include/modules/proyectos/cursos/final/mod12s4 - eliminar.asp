...
<%	
	...
	PRY_ObsCumplimientosPropuestos	 = LimpiarUrl(request("PRY_ObsCumplimientosPropuestos"))
	PRY_ObsCumplimientosFechas		 = LimpiarUrl(request("PRY_ObsCumplimientosFechas"))
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "'," & PRY_Step & ",'" & PRY_ObsCumplimientosPropuestos & "','" & PRY_ObsCumplimientosFechas & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"

	sql="exec [spProyectoInformeFinalCumplimiento_Modificar] " & datos 	
