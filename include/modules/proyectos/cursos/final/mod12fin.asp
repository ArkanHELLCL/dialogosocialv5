...
<%	
	...
	MEN_Texto			= "Informe FINAL ha sido CERRADO (ESCUELA)"
	MEN_Archivo			= ""
	...
	sql="exec spProyectoInformeFinal_Cerrar " & PRY_Id & ",'" & PRY_Identificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	{"state": 200, "message": "Informe Final correctamente cerrado","data": null}<%
