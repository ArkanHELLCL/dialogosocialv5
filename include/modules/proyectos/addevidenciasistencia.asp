...
<%	
	...
	sql="exec spEvidenciaAsistencia_Agregar " & PRY_Id & ",'" & PRY_Identificador & "','" & fileName & "',1007,'" & fileExt & "','" & path & "',95,'" & fileType & "'," & PLN_Sesion & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'" 
