...
<%
		...
		<div class="tab-content"><%
			if LFO_Id=99 then%>
				<div id="facilitadorestab1">
					<form role="form" name="frm13s1_1" id="frm13s1_1" class="needs-validation">
						<div class="row">
				...
				<div id="acuerdostab2">
					<form role="form" name="frm13s1_2" id="frm13s1_2" class="needs-validation">
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12">
								<div class="md-form">
									<div class="error-message">								
				...
				<div id="desafiostab3">
					<form role="form" name="frm13s1_3" id="frm13s1_3" class="needs-validation">
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12">
								<div class="md-form">
									<div class="error-message">								
			...
			<div id="sugerenciastab4">
				<form role="form" name="frm13s1_4" id="frm13s1_4" class="needs-validation">
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="md-form">
								<div class="error-message">								
	...
	<div class="row">		
		<div class="footer"><%
			if mode="mod" then%>			
				<button type="button" class="btn <%=btnColor%> btn-md waves-effect waves-dark" id="btn_frm13s1" name="btn_frm13s1"><%=txtBoton%></button><%					
			else%>				
...
<script>	
	$(document).ready(function() {			
		...
		$("#btn_frm13s1").click(function(e){
			e.preventDefault();
			e.stopImmediatePropagation();
			e.stopPropagation();
			
			<%if LFO_Id=99 then%>
				formValidate("#frm13s1_1");			
				formValidate("#frm13s1_2");
				formValidate("#frm13s1_3");
			<%end if%>
			formValidate("#frm13s1_4");
			<%if LFO_Id=99 then%>
				var frm1=false;
				var frm2=false;
				var frm3=false;
			...
			if(frm4){
				<%if LFO_Id=99 then%>
					var data1 = $("#frm13s1_1").serializeArray();
					var data2 = $("#frm13s1_2").serializeArray();
					var data3 = $("#frm13s1_3").serializeArray();
				<%end if%>
				var data4 = $("#frm13s1_4").serializeArray();
