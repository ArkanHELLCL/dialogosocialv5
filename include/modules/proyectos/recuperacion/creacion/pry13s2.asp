		...
		<div class="col-sm-12 col-md-4 col-lg-4">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeConsensosFecha" class="<%=lblClass%>">Fecha Cierre Informe Nro 2 (<%=LIN_DiasCierreInformeParcial%>)</label>									
				</div>
			</div>
		</div>			
		<div class="col-sm-12 col-md-4 col-lg-4">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeSistematizacionFecha" class="<%=lblClass%>">Fecha Cierre Informe Nro 3 (<%=LIN_DiasCierreInformeFinal%>)</label>									
				</div>
			</div>
		</div>
	</div>	
		...
		<div class="col-sm-12 col-md-4 col-lg-4">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeSistematizacionFechaOriginal" class="<%=lblClass%>">Fecha Cierre Informe Nro 3</label>									
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">		
		<div class="footer"><%
			if mode="mod" or mode="add" then%>		
				<button type="button" class="btn <%=btnColor%> btn-md waves-effect waves-dark" id="btn_frm13s2" name="btn_frm13s2"><%=txtBoton%></button><%
			else%>
