...
<%	
	...
	TIP_Id				= 30	'Cierre Informe INICIAL
	MEN_Archivo			= ""	'Sin adjuntos
	MEN_Texto			= "Informe INICIAL ha sido CERRADO (RECUPERACIÓN)"
	MEN_Archivo			= ""
	...
	sql="exec spProyectoInformeInicial_Cerrar " & PRY_Id & ",'" & PRY_Identificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	{"state": 200, "message": "Informe Inicial correctamente cerrado","data": null}<%
