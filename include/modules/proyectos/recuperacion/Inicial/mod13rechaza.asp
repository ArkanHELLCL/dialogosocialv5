...
<%	
	...
	TIP_Id				= 9	'Observaciones al informe INICIAL
	MEN_Archivo			= ""	'Sin adjuntos
	MEN_Texto			= request("MEN_TextoRechazo") & " (RECUPERACIÓN)"
	MEN_Archivo			= ""
	...
	sql="exec spProyectoInformeInicial_Abrir " & PRY_Id & ",'" & PRY_Identificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
	...
	{"state": 200, "message": "Informe Inicial correctamente rechazado","data": null}<%
