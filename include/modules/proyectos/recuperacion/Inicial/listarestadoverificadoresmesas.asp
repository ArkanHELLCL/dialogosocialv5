...
<%	
    ...
    VER_SubidosPendientes = (CTR_EstadoSubidoTotal + PAT_EstadoSubidoTotal + PRS_EstadoSubidoTotal + PLC_EstadoSubidoTotal + TED_EstadoSubidoTotal) - VER_RevisadosTotal		'Subidos no revisados
