...
<%	
	...
	TIP_Id				= 31	'Cierre Informe Desarrollo
	MEN_Archivo			= ""	'Sin adjuntos
	MEN_Texto			= "Informe Desarrollo ha sido CERRADO (RECUPERACIÓN)"
	MEN_Archivo			= ""
	...
	sql="exec spProyectoInformeConsensos_Cerrar " & PRY_Id & ",'" & PRY_Identificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
