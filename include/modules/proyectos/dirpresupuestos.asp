...
<%	
	...
	response.write("200/@/")%>	
	<table id="tbl-cuotas" class="table table-striped table-bordered table-sm" data-id="cuotas" data-page="false" data-selected="false" data-keys="0" style="margin-top:20px;" width="100%"> 
	<thead> 
		<tr> 
			<th>Corr</th> 
			<th>Nombre</th>
	...
	<tbody><%
		...
		Set directorio = fso.GetFolder ("D:\DocumentosSistema\dialogosocial\" & PRY_Carpeta & "\presupuestos\" & PRE_NumCuota)
		For Each fichero IN directorio.Files
			...
			<tr> 
				...
				<th><i class="fas fa-cloud-download-alt text-primary arcalm" data-file="<%=fichero.Name%>" data-pry="<%=PRY_Id%>" style="cursor:pointer;" data-cuota="<%=PRE_NumCuota%>"></i></th>
			</tr><%
		Next%>
	</tbody>                 
</table>