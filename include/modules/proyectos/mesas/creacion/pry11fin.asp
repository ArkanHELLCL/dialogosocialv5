				...
				$.ajax({
					...
					success: function(data) {					
						...
						if(param[0]=="200"){
							...
							wrk_informes('/prt-informecreacionmesas','informecreacionmesas.pdf',<%=PRY_Id%>,'<%=PRY_Identificador%>','/mnu-11',<%=session("ds5_usrid")%>,'<%=session("ds5_usrtoken")%>');
