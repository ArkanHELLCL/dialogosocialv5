...
<%	
	...
	PRY_DiagnosticoSocioLaboral		= LimpiarUrl(request("PRY_DiagnosticoSocioLaboral"))	
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "','" & PRY_DiagnosticoSocioLaboral & "'," & PRY_Step & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"

	sql="exec spProyectoMesa_DiagnosticoSocioLaboralModificar " & datos 	
