...
<%	
	...
	OES_ObjetivoEspecifico 	= LimpiarUrl(request("OES_ObjetivoEspecifico"))
	OES_ResultadoEsperado  	= LimpiarUrl(request("OES_ResultadoEsperado"))
	OES_Indicador			= LimpiarUrl(request("OES_Indicador"))
		
	sql = "exec spObjetivoEspecifico_Agregar '" & OES_ObjetivoEspecifico & "','" & OES_ResultadoEsperado & "','" & OES_Indicador & "',''," & PRY_Id & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"	
