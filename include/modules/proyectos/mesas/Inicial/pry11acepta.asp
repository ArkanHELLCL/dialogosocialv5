...
<div class="modal fade in" id="modalRechaza" tabindex="-1" role="dialog" aria-labelledby="modalRechazaLabel" aria-hidden="true">
	<div class="modal-dialog cascading-modal narrower modal-lg" role="document">  		
    	<div class="modal-content">		
			...
			<form role="form" action="/mod-11-h1-rechaza" method="POST" name="frmrechazainicio" id="frmrechazainicio" class="needs-validation">
					...
					if(data.state=="200"){						
						...
						if(VPR_EstadoAprobadoTotal<VPR_Total){
							swalWithBootstrapButtons.fire({
								...
								text:'Antes de aceptar el informe INICIAL, debes tener APROBADOS todos los documentos solicitados en el ítem "Informe"'
							});	
						}else{										
							swalWithBootstrapButtons.fire({
								...
								$.ajax({
									...
									success: function(data) {						
										if(data.state=="200"){
											...
											wrk_informes('/prt-informeinicialmesas','informeinicialmesas.pdf',<%=PRY_Id%>,'<%=PRY_Identificador%>','/mnu-11',<%=session("ds5_usrid")%>,'<%=session("ds5_usrtoken")%>');
