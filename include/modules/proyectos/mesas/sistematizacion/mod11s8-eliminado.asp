...
<%	
	...
	PRY_TematicaGeneral				= LimpiarUrl(request("PRY_TematicaGeneral"))	
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "','" & PRY_TematicaGeneral & "'," & PRY_Step & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"


	sql="exec [spProyectoTematicaGeneral_Modificar] " & datos 	
