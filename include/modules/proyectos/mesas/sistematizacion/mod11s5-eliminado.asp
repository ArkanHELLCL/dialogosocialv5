...
<%	
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "'," & PRY_Step & ",'" & PRY_PrincipalesAcuerdos & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"


	sql="exec [spPryInformeSistematizacionAcuerdos_Modificar] " & datos 	
