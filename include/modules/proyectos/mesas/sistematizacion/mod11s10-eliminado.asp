...
<%	
	...
	PRY_SeminarioResultados			= LimpiarUrl(request("PRY_SeminarioResultados"))	
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "','" & PRY_SeminarioResultados & "'," & PRY_Step & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"


	sql="exec [spProyectoSeminarioResultados_Modificar] " & datos 	
