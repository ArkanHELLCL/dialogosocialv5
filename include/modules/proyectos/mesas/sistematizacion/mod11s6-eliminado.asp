...
<%	
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "'," & PRY_Step & ",'" & PRY_Desafios & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"


	sql="exec [spPryInformeSistematizacionDesafios_Modificar] " & datos 	
