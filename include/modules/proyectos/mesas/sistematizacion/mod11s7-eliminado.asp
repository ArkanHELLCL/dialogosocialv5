...
<%	
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "'," & PRY_Step & ",'" & PRY_Sugerencias & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"


	sql="exec [spPryInformeSistematizacionSugerencias_Modificar] " & datos 	
