...
<%	
	...
	NIV_IdPropuesto					= request("NIV_IdPropuesto")
	NIV_IdLogrado					= request("NIV_IdLogrado")
	PRY_DescripcionNivel			= LimpiarUrl(request("PRY_DescripcionNivel"))
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "'," & PRY_Step & "," & NIV_IdPropuesto & "," & NIV_IdLogrado & ",'" & PRY_DescripcionNivel & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"

	sql="exec [spPryInformeSistematizacionNivel_Modificar] " & datos 	
