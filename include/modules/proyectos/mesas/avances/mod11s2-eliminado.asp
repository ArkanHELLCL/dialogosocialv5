...
<%	
	...
	PRY_AvancesFacilitadores		= LimpiarUrl(request("PRY_AvancesFacilitadores"))
	PRY_AvancesObstaculizadores		= LimpiarUrl(request("PRY_AvancesObstaculizadores"))
	PRY_AvancesSintesis				= LimpiarUrl(request("PRY_AvancesSintesis"))
	...
	datos =  PRY_Id & ",'" & PRY_Identificador & "','" & PRY_AvancesFacilitadores & "','" & PRY_AvancesObstaculizadores & "','" & PRY_AvancesSintesis & "'," & PRY_Step & "," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"

	sql="exec [spAvanceProyecto_Modificar] " & datos 	
