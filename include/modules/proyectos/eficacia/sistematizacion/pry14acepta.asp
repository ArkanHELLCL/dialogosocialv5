...
<div class="modal fade in" id="modalRechaza" tabindex="-1" role="dialog" aria-labelledby="modalRechazaLabel" aria-hidden="true">
	<div class="modal-dialog cascading-modal narrower modal-lg" role="document">  		
    	<div class="modal-content">		
			...
			<form role="form" action="/mod-14-h4-rechaza" method="POST" name="frmrechazainicio" id="frmrechazainicio" class="needs-validation">
												...
												$.ajax({
													...
													success: function(data) {						
														if(data.state=="200"){
															...
															wrk_informes('/prt-informefinalrecuperacion','informefinalrecuperacion.pdf',<%=PRY_Id%>,'<%=PRY_Identificador%>','/mnu-14',<%=session("ds5_usrid")%>,'<%=session("ds5_usrtoken")%>');
