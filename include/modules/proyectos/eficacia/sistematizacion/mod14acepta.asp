...
<%	
	...
	'TIP_Id				= 25	'Aceptación Informe SISTEMATIZACIÓN
	TIP_Id				= 22	'Aceptación Informe Final
	MEN_Archivo			= ""	'Sin adjuntos
	MEN_Texto			= "Informe FINAL ha sido ACEPTADO (EFICACIA)"
	MEN_Archivo			= ""
	Informe				= 4		'Informe Final Eficacia
	...
	{"state": 200, "message": "Informe Sistematización correctamente aceptado","data": null}<%
