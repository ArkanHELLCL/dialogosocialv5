...
<%
	...
	response.write("200/@/")	
%>
<form role="form" action="<%=action%>" method="POST" name="frm14s2" id="frm14s2" class="needs-validation">
		...
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<label for="PRY_InformeInicialFecha" class="<%=lblClass%>">Fecha Cierre Informe Nro 1</label>									
				</div>
			</div>
		</div>
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeConsensosFecha" class="<%=lblClass%>">Fecha Cierre Informe Nro 2 </label>									
				</div>
			</div>
		</div>	
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeParcialFecha" class="<%=lblClass%>">Fecha Cierre Informe Nro 3</label>									
				</div>
			</div>
		</div>			
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeSistematizacionFecha" class="<%=lblClass%>">Fecha Cierre Informe Nro 4</label>									
				</div>
			</div>
		</div>
	</div>	
		...
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeInicialFechaOriginal" class="<%=lblClass%>">Fecha Cierre Informe Nro 1</label>									
				</div>
			</div>
		</div>
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeConsensosFechaOriginal" class="<%=lblClass%>">Fecha Fecha Cierre Informe Nro 2</label>									
				</div>
			</div>
		</div>
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeParcialFechaOriginal" class="<%=lblClass%>">Fecha Fecha Cierre Informe Nro 3</label>									
				</div>
			</div>
		</div>		
		<div class="col-sm-12 col-md-3 col-lg-3">
			<div class="md-form input-with-post-icon">
				<div class="error-message">								
					...
					<span class="select-bar"></span>
					<label for="PRY_InformeSistematizacionFechaOriginal" class="<%=lblClass%>">Fecha Cierre Informe Nro 4</label>									
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">		
		<div class="footer"><%
			if mode="mod" or mode="add" then%>		
				<button type="button" class="btn <%=btnColor%> btn-md waves-effect waves-dark" id="btn_frm14s2" name="btn_frm14s2"><%=txtBoton%></button><%
			else%>
...
<script>
	...
	$("#PRY_InformeConsensosFecha").change(function(){		
	...
	$("#PRY_InformeSistematizacionFecha").change(function(){		
	...
	$("#PRY_InformeParcialFecha").change(function(){		
	...
	$(document).ready(function() {						
		$("#btn_frm14s2").click(function(){
			formValidate("#frm14s2")
			if($("#frm14s2").valid()){
				var bb = String.fromCharCode(92) + String.fromCharCode(92);
				$.ajax({
					type: 'POST',			
					url: $("#frm14s2").attr("action"),
					data: $("#frm14s2").serialize(),
