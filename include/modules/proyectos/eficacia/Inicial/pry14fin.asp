			...
			<form role="form" action="<%=action%>" method="POST" name="frm14sfin" id="frm14sfin" class="needs-validation">
				<div class="row align-items-center">
					<div class="col-sm-6 col-md-6 col-lg-6" style="text-align:center;height:100%">
						<button type="button" class="btn btn-danger btn-lg" id="btn_frm14fin" name="btn_frm14fin" value="enviar"><i class="fas fa-door-open"></i> Cerrar Hito INICIAL</button>
					</div>
	...
	$(document).ready(function() {	
		...
		$("#btn_frm14fin").click(function(){
			swalWithBootstrapButtons.fire({
			  ...
			  text: '¿Estas seguro de querer cerrar del Hito "INICIAL" para dar inicio al desarrollo del programa?',
			  icon: 'question',
