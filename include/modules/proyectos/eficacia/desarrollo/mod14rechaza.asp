...
<%	
	...
	TIP_Id				= 6	'Observaciones al informe DESARROLLO
	MEN_Archivo			= ""	'Sin adjuntos
	MEN_Texto			= LimpiarURL(request("MEN_TextoRechazo")) & " (EFICACIA)"
	MEN_Archivo			= ""
	...
	sql="exec spProyectoInformeParcial_Abrir " & PRY_Id & ",'" & PRY_Identificador & "'," & session("ds5_usrid") & ",'" & session("ds5_usrtoken") & "'"
