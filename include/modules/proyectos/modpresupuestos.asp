...
<%	
	...
	PRE_GlosaFactura = LimpiarUrl(up.form("PRE_GlosaFactura"))
	'PRE_Adjunto = ""
	PRE_Adjunto = up.form("PRE_AdjuntoX")
	...
	if(PRE_EstadoCuota="undefined") then
		if(PRE_MontoCuota=PRE_MontoFactura) then
			PRE_EstadoCuota=1
		else
			PRE_EstadoCuota=0
		end if
